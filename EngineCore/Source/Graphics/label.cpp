...
namespace engine {	namespace graphics {
	...
	Label::Label(const std::string& text, float x, float y, const maths::Vec4& color, Font* font)
	...
	Label::Label(const std::string& text, float x, float y, const maths::Vec4& color, const std::string& font)
	...
	Label::Label(const std::string& text, float x, float y, const maths::Vec4& color, const std::string& font, unsigned int size)
